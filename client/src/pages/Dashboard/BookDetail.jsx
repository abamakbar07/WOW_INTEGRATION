...
const BookDetail = (props) => {
   ...
   const bookDetailPage = props.bookDetailPage
   ...
   return (
     <div className="BookDetail">
       <pre>{JSON.stringify(stateBook)}</pre>
       <pre>{stateBook.bookDetailId}</pre>
           ...
           <div className="col-md-8">
             <ListGroup horizontal>
               <ListGroup.Item className="text-left border-0 bg-transparent">
                 ...
                 <small className="text-muted">Rachel Hartman</small>
               </ListGroup.Item>
             </ListGroup>
             <ListGroup horizontal>
         ...
         <div className="row mt-5 mb-5">
           <div className="col-sm-12">
             ...
             <p className="BookDetail-aboutSub text-left">
               ...
               Southlands, alone and pretending to be a boy. Where Tess is
               ...
               ways than one. Returning to the fascinating world she created in
               the award-winning and New York Times bestselling Seraphina,
               Rachel Hartman introduces readers to a new character and a new
               quest, pushing the boundaries of genre once again in this wholly
               original fantasy.
             </p>
           </div>
         </div>
           ...
           <div className="col-sm-12 text-right">
             ...
             >
               <button className="btn btn-danger m-1">
                 Add My List <img alt="" className="ml-2" src={iconBookmark} />
               </button>
             </Link>
